...
- 2026-04-28T19:38:30.788-05:00 — Bone Revenant split-phase collision reuses the shared boss hit pipeline: `getBossHitTarget()` already finds live twin bodies, so split bugs come from damage gating/state (`boss.hidden`, shared health), not from melee overlap math.
- 2026-04-28T19:42:03.083-05:00 — Bone Revenant split-phase mechanic now uses twin-driven state: hitting a twin half reforms the whole boss instead of killing that half, health continues declining normally, no health reset on split, dead-twin filters removed.
